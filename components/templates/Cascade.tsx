...
export default function CascadeTemplate({ data }: Props) {
  ...
  return (
    <div style={{ fontFamily: getBodyFontFamily(data.settings), color: "#1A1918", background: "#fff", padding: "0" }}>
      <div style={{ background: `linear-gradient(135deg, ${accentColor} 0%, ${accentColor}88 100%)`, padding: p3228 }}>
        <h1 style={{ fontFamily: getFontFamily(data.settings), fontSize: 28*s, fontWeight: 800, letterSpacing: "-0.03em", margin: `0 0 ${4*s}px`, color: "#fff" }}>{personal.name || "Nombre"}</h1>
      ...
      <div style={{ padding: p3248 }}>
        ...
        {data.settings.sections.certifications && certifications.length > 0 && <section style={{ marginBottom: p26 }}>
          <div style={{ width: p40, height: p3, background: accentColor, borderRadius: 2, marginBottom: p12 }} />
          <h2 style={{ fontSize: 10*s, fontWeight: 700, fontFamily: getFontFamily(data.settings), textTransform: "uppercase", letterSpacing: "0.06em", color: "#6B6860", margin: `0 0 ${p12}` }}>Certificaciones</h2>
        ...
        {data.settings.sections.awards && awards.length > 0 && <section style={{ marginBottom: p26 }}>
          <div style={{ width: p40, height: p3, background: accentColor, borderRadius: 2, marginBottom: p12 }} />
          <h2 style={{ fontSize: 10*s, fontWeight: 700, fontFamily: getFontFamily(data.settings), textTransform: "uppercase", letterSpacing: "0.06em", color: "#6B6860", margin: `0 0 ${p12}` }}>Premios</h2>
        ...
        {data.settings.sections.licenses && licenses.length > 0 && <section style={{ marginBottom: p26 }}>
          <div style={{ width: p40, height: p3, background: accentColor, borderRadius: 2, marginBottom: p12 }} />
          <h2 style={{ fontSize: 10*s, fontWeight: 700, fontFamily: getFontFamily(data.settings), textTransform: "uppercase", letterSpacing: "0.06em", color: "#6B6860", margin: `0 0 ${p12}` }}>Licencias</h2>
        ...
        {data.settings.sections.references && references.length > 0 && <section style={{ marginBottom: p26 }}>
          <div style={{ width: p40, height: p3, background: accentColor, borderRadius: 2, marginBottom: p12 }} />
          <h2 style={{ fontSize: 10*s, fontWeight: 700, fontFamily: getFontFamily(data.settings), textTransform: "uppercase", letterSpacing: "0.06em", color: "#6B6860", margin: `0 0 ${p12}` }}>Referencias</h2>
        ...
        {data.settings.sections.affiliations && affiliations.length > 0 && <section style={{ marginBottom: p26 }}>
          <div style={{ width: p40, height: p3, background: accentColor, borderRadius: 2, marginBottom: p12 }} />
          <h2 style={{ fontSize: 10*s, fontWeight: 700, fontFamily: getFontFamily(data.settings), textTransform: "uppercase", letterSpacing: "0.06em", color: "#6B6860", margin: `0 0 ${p12}` }}>Afiliaciones</h2>
