...
export default function CedarTemplate({ data }: Props) {
  ...
  return (
    <div style={{ fontFamily: getBodyFontFamily(data.settings), color: "#1A1918", background: "#FDFDF0", padding: p4048 }}>
      <header style={{ marginBottom: p32 }}>
        <h1 style={{ fontFamily: getFontFamily(data.settings), fontSize: 28*s, fontWeight: 700, letterSpacing: "-0.02em", margin: `0 0 ${4*s}px`, color: "#1F3A0A" }}>{personal.name || "Nombre"}</h1>
      ...
      {data.settings.sections.experience && experience.length > 0 && <section style={{ marginBottom: p28 }}>
        <h2 style={{ fontSize: 11*s, fontWeight: 700, fontFamily: getFontFamily(data.settings), textTransform: "uppercase", letterSpacing: "0.14em", color: accentColor, margin: `0 0 ${p16}` }}>Experiencia</h2>
      ...
      {data.settings.sections.education && education.length > 0 && <section style={{ marginBottom: p28 }}>
        <h2 style={{ fontSize: 11*s, fontWeight: 700, fontFamily: getFontFamily(data.settings), textTransform: "uppercase", letterSpacing: "0.14em", color: accentColor, margin: `0 0 ${p16}` }}>Educación</h2>
